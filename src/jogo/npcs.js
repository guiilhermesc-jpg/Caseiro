...
const ROSTER = [
  { nome: 'Othmar', prof: 'Mercador', post: { x: 17, z: 11 }, cor: 0x7a4632, humor: 'bom', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Maerla', prof: 'Padeira', post: { x: 4, z: -104 }, cor: 0xd8c4a0, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Brannor', prof: 'Ferreiro', post: { x: -17, z: 11 }, cor: 0x445162, humor: 'mau', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Seranna', prof: 'Curandeira', post: { x: 30, z: 3 }, cor: 0xeef0f2, humor: 'bom', sexo: 'mulher', tipo: 'mago',
  ...
  { nome: 'Eldrith', prof: 'Vendedora de Runas', post: { x: -22, z: 17 }, cor: 0x5a2a8a, humor: 'bom', sexo: 'mulher', tipo: 'mago',
  ...
  { nome: 'Falric', prof: 'Arqueiro', post: { x: 22, z: -15 }, cor: 0x3a5a2a, humor: 'bom', sexo: 'homem', tipo: 'cacador',
  ...
  { nome: 'Tovaryn', prof: 'Sacerdote', post: { x: 0, z: -34 }, cor: 0x6a4a8a, humor: 'bom', sexo: 'homem', tipo: 'mago',
  ...
  { nome: 'Lyria', prof: 'Escriba', post: { x: 3, z: 23 }, cor: 0x3a5a8a, humor: 'bom', sexo: 'mulher', tipo: 'mago',
  ...
  { nome: 'Marwen', prof: 'Fazendeira', post: { x: 16, z: -15 }, cor: 0x556b2f, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
    falas: { trabalho: 'Cuido das hortas e deste poço. Água limpa é vida.', dica: 'As flores azuis só nascem à beira d’água.' } },
  { nome: 'Valdric', prof: 'Guarda', post: { x: -24, z: -3 }, cor: 0x2a3a6a, humor: 'mau', sexo: 'homem', tipo: 'cavaleiro',
  ...
  { nome: 'Noren', prof: 'Aldeão', post: { x: 28, z: 18 }, cor: 0x6a2a3a, humor: 'bom', sexo: 'homem', tipo: 'aldeao',
    falas: { trabalho: 'Eu? Só vivo por aqui, vendo a vida passar.', dica: 'Venore já foi maior. As montanhas guardam segredos.' } },
  { nome: 'Ilyra', prof: 'Aldeã', post: { x: -28, z: -18 }, cor: 0x8a6a2a, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
    falas: { trabalho: 'Costuro e cuido das ruas do lado oeste.', dica: 'Dizem que há cidades além das montanhas.' } },
  { nome: 'Caelen', prof: 'Pescador', post: { x: 43, z: 64 }, cor: 0x2a6a5a, humor: 'bom', sexo: 'homem', tipo: 'cacador',
    falas: { trabalho: 'Pesco aqui do cais do porto. Paciência é tudo.', dica: 'Cada lago tem seus peixes — e a Ysolde de Thais paga bem pelos raros.' } },
  // --- moradores de THAIS (cidade distante, agora em x≈560) ---
  { nome: 'Darian', prof: 'Guardião do Portão', post: { x: 520, z: 6 }, home: { x: 548, z: -12 }, cor: 0x6a5a3a, humor: 'mau', sexo: 'homem', tipo: 'cavaleiro',
  ...
  // Ysolde agora atende DENTRO da loja de poções (interior de verdade, atrás do balcão)
  { nome: 'Ysolde', prof: 'Mercadora', post: { x: 572, z: -21.2 }, home: { x: 572, z: -12 }, cor: 0xb8902a, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Aldren', prof: 'Sacerdote de Thais', post: { x: 560, z: 9 }, home: { x: 556, z: -10 }, cor: 0x2f7d72, humor: 'bom', sexo: 'homem', tipo: 'mago',
  ...
  { nome: 'Kael', prof: 'Caçador', post: { x: 546, z: -10 }, home: { x: 548, z: -12 }, cor: 0x4a6a2a, humor: 'bom', sexo: 'homem', tipo: 'cacador',
  ...
  { nome: 'Brenna', prof: 'Aldeã', post: { x: 566, z: -10 }, home: { x: 572, z: -12 }, cor: 0xc05a7a, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Brannar', prof: 'Vigia da Estrada', post: { x: 122, z: -2 }, home: { x: 122, z: -6 }, cor: 0x2a3a6a, humor: 'mau', sexo: 'homem', tipo: 'cavaleiro',
  ...
  { nome: 'Gildren', prof: 'Lavrador', post: { x: 105, z: 53 }, home: { x: 105, z: 50 }, cor: 0x8a6a2a, humor: 'bom', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Anshelm', prof: 'Mercador', post: { x: -320, z: -13 }, home: { x: -322, z: -44 }, cor: 0x8a6a2a, humor: 'bom', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Berthya', prof: 'Alquimista', post: { x: -284, z: -47.3 }, home: { x: -284, z: -38 }, cor: 0x7a3a6a, humor: 'bom', sexo: 'mulher', tipo: 'mago',
    ...
    compra: ['Erva', 'Cogumelo', 'Frasco'],
    ofertas: [{ precisa: 10, item: { nome: 'Poção Grande', icone: '🧉', preco: 20, slot: 'pocao', usavel: 'pocaoGrande' } }] },
  { nome: 'Gromar', prof: 'Ferreiro', post: { x: -308, z: -53.4 }, home: { x: -340, z: -42 }, cor: 0x445162, humor: 'mau', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Ilyndra', prof: 'Arcanista', post: { x: -343.4, z: -12 }, home: { x: -376, z: -20 }, cor: 0x5a2a8a, humor: 'bom', sexo: 'mulher', tipo: 'mago',
    ...
    compra: ['Erva', 'Frasco', 'Olho do Beholder', 'Seda de Aranha'],
    ofertas: [{ precisa: 10, item: { nome: 'Runa Explosiva', icone: '💣', preco: 60, slot: 'runa', usavel: 'runaExplosiva' } }] },
  { nome: 'Tormund', prof: 'Pescador', post: { x: -322, z: -81 }, home: { x: -272, z: -20 }, cor: 0x2a6a5a, humor: 'bom', sexo: 'homem', tipo: 'cacador',
  ...
  { nome: 'Ema Velharra', prof: 'Padeira', post: { x: -326, z: -10 }, home: { x: -392, z: -20 }, cor: 0xd8c4a0, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Mara Veyr', prof: 'Guarda do Canal', post: { x: -256, z: -34 }, home: { x: -296, z: -46 }, cor: 0x2a3a6a, humor: 'mau', sexo: 'mulher', tipo: 'cavaleiro',
  ...
  { nome: 'Thessara', prof: 'Armadureira', post: { x: -286.8, z: 22 }, home: { x: -340, z: 28 }, cor: 0x6a5a4a, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Ulrion', prof: 'Mestre da Guilda', post: { x: -320, z: 27 }, home: { x: -320, z: 30 }, cor: 0x7a1f2a, humor: 'mau', sexo: 'homem', tipo: 'cavaleiro',
  ...
  { nome: 'Helyra', prof: 'Sacerdotisa', post: { x: -386, z: 16 }, home: { x: -390, z: 12 }, cor: 0x4a3a7a, humor: 'bom', sexo: 'mulher', tipo: 'mago',
  ...
  { nome: 'Berron', prof: 'Estivador', post: { x: -292, z: -82 }, home: { x: -300, z: -78 }, cor: 0x5a4a3a, humor: 'bom', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Rosmara', prof: 'Florista', post: { x: -316, z: 14 }, home: { x: -376, z: 44 }, cor: 0xc05a7a, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Nyrion', prof: 'Cronista', post: { x: -326, z: -36 }, home: { x: -272, z: 30 }, cor: 0x3a5a8a, humor: 'bom', sexo: 'homem', tipo: 'mago',
  ...
  { nome: 'Ivareth', prof: 'Lavadeira', post: { x: -346, z: -2 }, home: { x: -396, z: 44 }, cor: 0x6a8a5a, humor: 'bom', sexo: 'mulher', tipo: 'aldeao',
  ...
  { nome: 'Zareth das Rotas', prof: 'Mascate', post: { x: POSTO_MASCATE[0], z: POSTO_MASCATE[1] }, home: { x: POSTO_MASCATE[0], z: POSTO_MASCATE[1] }, cor: 0x9c6a2a, humor: 'bom', sexo: 'homem', tipo: 'aldeao',
  ...
  { nome: 'Caldrath', prof: 'Ferreiro Sombrio', post: { x: -590, z: -52 }, home: { x: -586, z: -52 }, cor: 0x5a4a42, humor: 'mau', sexo: 'homem', tipo: 'aldeao',
...
const NOTURNOS = new Set(['Othmar', 'Maerla', 'Brannor', 'Valdric', 'Darian', 'Ysolde', 'Brannar', 'Tovaryn', 'Eldrith', 'Falric',
  'Anshelm', 'Berthya', 'Gromar', 'Ilyndra', 'Mara Veyr', 'Thessara', 'Ulrion', 'Helyra',
  'Nerion', 'Caldrath', 'Mira Noctar']); // lojistas/templo/guarda viram a noite no posto

const LEGADO_NOMES = {
  Othmar: 'Otto', Maerla: 'Greta', Brannor: 'Bram', Seranna: 'Sira', Eldrith: 'Eldra',
  Falric: 'Falk', Tovaryn: 'Tobias', Lyria: 'Lia', Marwen: 'Marta', Valdric: 'Vasco',
  Noren: 'Nuno', Ilyra: 'Inês', Caelen: 'Caio', Darian: 'Dorian', Ysolde: 'Yara',
  Aldren: 'Aldo', Kael: 'Khan', Brenna: 'Bibi', Brannar: 'Bruno', Gildren: 'Gil',
  Anshelm: 'Anselmo', Berthya: 'Berta', Gromar: 'Grom', Ilyndra: 'Ilda', Tormund: 'Tonho',
  'Ema Velharra': 'Dona Ema', 'Mara Veyr': 'Capitã Mara', Thessara: 'Tessa',
  Ulrion: 'Ulric', Helyra: 'Hela', Berron: 'Beto', Rosmara: 'Rosa', Nyrion: 'Nilo',
  Ivareth: 'Iva', 'Zareth das Rotas': 'Zé das Rotas', Caldrath: 'Calder',
};
...
export function criaNPCs(scene, colide) {
  ...
  ROSTER_ATIVO.forEach((d, i) => {
    ...
    const npc = {
      ...
      nome: d.nome, legacyNome: LEGADO_NOMES[d.nome], prof: d.prof, humor: d.humor, falas: d.falas,
      loja: d.loja ? d.loja.map((it) => ({ ...it, pacote: it.pacote ? { ...it.pacote } : undefined })) : undefined,
      compra: d.compra ? [...d.compra] : undefined,
      ofertas: d.ofertas ? d.ofertas.map((of) => ({ ...of, item: { ...of.item } })) : undefined,

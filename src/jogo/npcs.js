...
const ROSTER = [
  { nome: 'Otto', prof: 'Mercador', post: { x: 12, z: 9 }, cor: 0x7a4632, humor: 'bom',
  ...
  { nome: 'Greta', prof: 'Padeira', post: { x: 12, z: -9 }, cor: 0xd8c4a0, humor: 'bom',
    falas: { trabalho: 'Faço o pão de Venore desde menina. Sinta o cheiro!', dica: 'Queijo fresco atrai ratos... e aventureiros famintos.' } },
  { nome: 'Bram', prof: 'Ferreiro', post: { x: -12, z: 9 }, cor: 0x445162, humor: 'mau',
  ...
  { nome: 'Sira', prof: 'Curandeira', post: { x: 22, z: 2 }, cor: 0xeef0f2, humor: 'bom',
  ...
  { nome: 'Tobias', prof: 'Sacerdote', post: { x: 4, z: -19 }, cor: 0x6a4a8a, humor: 'bom',
    falas: { trabalho: 'Toco o sino e guardo a fé de Venore.', dica: 'Aquele baú perto da igreja só abre com a chave certa.' } },
  { nome: 'Lia', prof: 'Escriba', post: { x: 4, z: 22 }, cor: 0x3a5a8a, humor: 'bom',
...
export function criaNPCs(scene, colide) {
  ...
  for (const d of ROSTER) {
    const g = criaAvatar({ casaco: d.cor, pele: pick(PELE), cabelo: pick(CABELO) });

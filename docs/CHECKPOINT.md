...
## 🚨 24ª RODADA (EM ABERTO) — PRÓXIMA SESSÃO, COMECE AQUI (atualizado 10/06 noite, RV4.0/v24)
> As rodadas **18ª a 23ª (RV4.0) FORAM EXECUTADAS** (resumos no diário, no fim do arquivo). Código no main; selo agora é **RV4.0 (v24)**.
> ⚖️ Regra de sempre: Tibia é INSPIRAÇÃO de estilo — layout, prédios, nomes e falas são NOSSOS (não replicar mapa/NPCs do jogo da CipSoft).

...
> Atualizado: 11/06/2026 (Patch 2 v46). Leia este arquivo primeiro ao reabrir o projeto.

---

## 🤝 HANDOFF PRO CODEX (11/06/2026) — 45ª RODADA FECHADA / 46ª PRÓXIMA
> O maestro vai passar algumas rodadas pro Codex. **LEIA ESTA SEÇÃO INTEIRA antes de tocar em qualquer arquivo.**

### 📦 ESTADO EXATO
- **Produção**: caseiro.pages.dev está no **PATCH 2 RV6.0 (v45)**; deploy manual Cloudflare Pages feito em 11/06/2026 e conferido contra o bundle `assets/index-CgWPPh3L.js`. Servidor de contas no Railway ON com Volume `/data` + `DATA_DIR=/data` (testado em produção via wss).
- **main (GitHub)**: acumula **v46 SEM deploy** — 45ª (automap grande + edição do personagem separada da ação). Produção ainda está no **PATCH 2 RV6.0 (v45)** até o próximo "pode publicar". Selo atual no main: **RV6.1 (v46)**. Diário completo das rodadas 12ª→45ª no FIM deste arquivo.

...
## 🚨 22ª RODADA (EM ABERTO) — PRÓXIMA SESSÃO, COMECE AQUI (atualizado 10/06 noite, v22)
> As rodadas **18ª a 21ª FORAM EXECUTADAS** (resumos no diário, no fim do arquivo). Código no main; selo de versão agora é `v22`.

...
## 🚨 39ª RODADA (EM ABERTO) — PATCH 2 EM ANDAMENTO (atualizado 11/06, RV5.4/v39)
> **PATCH 1 LANÇADO em 11/06/2026** (cliente v38 + servidor de contas com volume — tudo verificado em produção). A 38ª abriu o PATCH 2 pelos pedidos do maestro: portões, casas entráveis e chão vivo. **Deploy do v39 PENDENTE** (produção está no v38).
> 🧪 Testar (local/quando publicar): portões nas 3 entradas do vilarejo · 7 casas novas com porta aberta (2 vilarejo, 3 Venore, 2 Thais) · campo com manchas de capim seco/terra, flores 3D e seixos.

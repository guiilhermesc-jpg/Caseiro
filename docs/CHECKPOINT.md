...
## 🚨 21ª RODADA (EM ABERTO) — PRÓXIMA SESSÃO, COMECE AQUI (atualizado 10/06 noite, v21)
> As **18ª, 19ª e 20ª rodadas FORAM EXECUTADAS** (resumos no diário, no fim do arquivo). Código no main; selo de versão agora é `v21`.

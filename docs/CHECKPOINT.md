...
## 🚨 40ª RODADA (EM ABERTO) — PATCH 2 EM ANDAMENTO (atualizado 11/06, RV5.5/v40)
> **PATCH 1 LANÇADO em 11/06/2026** (cliente v38 + servidor de contas com volume — verificados em produção). Patch 2 acumulando: 38ª (portões/casas/chão) + 39ª (polimento de casas + jogabilidade). **Deploy do v39-v40 PENDENTE** (produção está no v38).
> 🧪 Testar quando publicar: portões do vilarejo · 7 casas novas · campo com manchas/flores/seixos · ENTRADAS com batente/degrau · BARRA DE VIDA nos bichos ao bater · rangido de porta ao entrar em casa · lamparina acesa nas mesas.
> 🔭 Fila do Patch 2: GLBs CC0 do maestro nos slots · feedback dos jogadores · variações por bioma (juncos/cogumelos/trigo) · mais masmorras · eventos de mundo · launcher (Electron/Tauri).

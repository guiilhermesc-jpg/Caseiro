...
- **main (GitHub)**: acumula **v39→v45 SEM deploy** — 38ª (portões/casas/chão vivo), 39ª (entradas/barra de HP/sons), 40ª (biomas), 41ª (mortos noturnos + Mascate), 42ª (Cavernas do Pico), 43ª (chefes com presença), 44ª (Noctaria + Lua Partida). Selo atual: **RV6.0 (v45)**. Diário completo das rodadas 12ª→44ª no FIM deste arquivo.
...
Deploy do v39→v45 quando o maestro liberar · GLBs CC0 nos slots (o maestro baixa de quaternius.com/poly.pizza) · interiores restantes (Anselmo?) · masmorra interna da Fenda/POI autoral · launcher Electron/Tauri · perf mobile (medir draw calls de verdade no aparelho).

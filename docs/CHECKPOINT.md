...
## 🚨 41ª RODADA (EM ABERTO) — PATCH 2 EM ANDAMENTO (atualizado 11/06, RV5.6/v41)
> **PATCH 1 LANÇADO em 11/06/2026** (cliente v38 + servidor de contas com volume — verificados em produção). Patch 2 acumulando: 38ª (portões/casas/chão) + 39ª (entradas/barra de HP/sons) + 40ª (biomas). **Deploy do v39-v41 PENDENTE** (produção está no v38).
> 🧪 Testar quando publicar: portões do vilarejo · 7 casas novas com entradas de batente/degrau · BARRA DE VIDA nos bichos · rangido de porta · lamparina nas mesas · campo com manchas/flores/seixos · JUNCOS em toda beira d'água · COGUMELOS no pé das árvores · CAMPO DE TRIGO na fazenda.
> 🔭 Fila do Patch 2: GLBs CC0 do maestro nos slots · feedback dos jogadores · mais masmorras · eventos de mundo · launcher (Electron/Tauri).
